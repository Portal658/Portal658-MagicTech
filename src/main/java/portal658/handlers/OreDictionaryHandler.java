...
public class OreDictionaryHandler
{
	public static void registerOreDictionary()
	{
		...
		OreDictionary.registerOre("oreIronCoin",
				new ItemStack(ModBlocks.coinOre, 1, ListCoinOres.IRON.getMetadata()));
		OreDictionary.registerOre("oreSilverCoin",
				new ItemStack(ModBlocks.coinOre, 1, ListCoinOres.SILVER.getMetadata()));
		OreDictionary.registerOre("oreEpicCoin",
				new ItemStack(ModBlocks.coinOre, 1, ListCoinOres.EPIC.getMetadata()));
	}
}
